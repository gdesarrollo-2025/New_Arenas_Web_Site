...
export default function HeroSection() {
  return (
    <section className="bg-white  select-none ">
      <div className="relative overflow-hidden  h-full lg:h-svh flex items-center justify-center">
        {/* Imagen de fondo */}
        <Image
          ...
          fill
          sizes="100vw"
          className="mask-b-from-80% mask-b-to-90% object-cover"
          priority
        />
        {/* Capa oscura solo en la parte inferior */}
        <div className="absolute bg-black/50 mask-b-from-80% mask-b-to-90% h-full w-full" />
        {/* Contenido principal */}
