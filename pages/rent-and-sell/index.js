...
const InfoPropietarios = {
    ...
    cards: [{
        title: "Somos la inmobiliaria que más arrienda",
        items: ["Equipo de mercadeo dedicado"
            , "Presencia en todos los portales"
            , "Fuerza comercial especializada"
            , "Proceso disciplinado con CRM propio"]
    },
    {
        title: "Pago puntual garantizado (y opción de anticipo)",
        items: ["Seguros y fianzas para todos los inmuebles"
            , "Equipo de contabilidad y operaciones"
            , "Control de servicios y administración al día"]
    },
    {
        title: "Administración integral según el uso del inmueble",
        items: ["Equipo comercial especializado"
            , "Comunicación constante con el propietario"
            , "Asesoría estratégica de pricing"
            , "Gestión de inmuebles desocupados"]
    },
    {
        title: "Mercadeo especializado para arrendar más rápido",
        items: ["Equipo de marketing experto"
            , "Agencia in-house"]
    },
    /* {
        title: "Más de 80 años de experiencia y transparencia",
        items: []
    }, */
    {
        title: "Negociaciones con respaldo SAGRILAFT",
        items: ["Acceso a bases de datos"
            , "Soporte jurídico"]
    },
    {
        title: "Servicio al cliente para fidelizar al inquilino",
        items: ["Atención según tipo de inmueble"
            , "Seguimiento anticipado de desocupaciones"
            , "Reparaciones ágiles"
            , "Gestión activa de satisfacción"
            , "Línea de emergencias"]
    },
    {
        title: "Seguros diseñados para su inmueble",
        items: ["Alianzas con aseguradoras"
            , "Pólizas colectivas negociadas"]
    },
    {
        title: "Acompañamiento legal y tributario",
        items: ["Equipo contable especializado"]
    },
    {
        title: "Canales de autogestión",
        items: ["Tecnología en evolución permanente"
            , "Plataforma web"
            , "CRM de autogestión"]
    },
        /*
...
const infoArrendatarios = {
    ...
    cards: [
        {
            title: "Amplio inventario de inmuebles",
            items: ["Tecnología para organizar la oferta",
                , "Capacidad experta de captación",
                , "Conocimiento profundo del inventario"]
        },
        {
            title: "Atención diferencial",
            items: ["Seguimiento activo de su búsqueda",
                "Equipo especializado"]
        },
        {
            title: "Servicio al cliente dedicado",
            items: ["Canales de comunicación directos"]
        },
        {
            title: "Entregas con acompañamiento total",
            items: ["Verificación de servicios y administración al día"
                , "Inspección preventiva del inmueble",
                , "Programación y guía en cada etapa"]
        },
        {
            title: "Busca tu inmueble en cualquier momento",
            items: ["Visualización 360°"]
        },
        {
            title: "Encuentra tu inmueble con menos visitas",
            items: ["Comprensión profunda de requerimientos",
                "Inventario actualizado en la web"]
        },
        /*
         {
...
const infoVendedores = {
    ...
    cards: [
        ...
        {
            title: "Servicio al cliente para fidelización del ocupante",
            items: ["Atención según tipo de inmueble"
                , "Seguimiento anticipado de desocupaciones"
                , "Reparaciones ágiles"
                , "Gestión activa de satisfacción"
        ...
        {
            title: "Seguros para las necesidades del inmueble",
            items: ["Relación con aseguradoras"
                , "Pólizas colectivas"]
        },
        {
            title: "Acompañamiento legal y tributario",
        ...
        {
            title: "Canales de autogestión",
            items: ["Innovación tecnológica continua"
                , "Plataforma web"
                , "CRM de autogestión"]
        },
        /*
...
const infoCompradores = {
    ...
    cards: [
        ...
        {
            title: "Asesoria técnica y jurídica en todo el proceso",
            items: ["Promesa, escritura y registro",
        ...
        {
            title: "Seguros ideales para su hogar",
            items: []
        },
        {
            title: "Validación SAGRILAFT de propietarios históricos",
            items: ["Acceso a bases de datos"
                , "Soporte jurídico"]
        }
    ],
...
export default function RentAndSell() {
    ...
    return (
        <>
            <Head>
                <title>Arriendo y Venta | Arenas Inmobiliaria</title>
            ...
            <div className="">
                ...
                <section className=" container-custom relative flex flex-col ">
                    <div className="z-20 bg-white absolute rounded-sm overflow-hidden -top-4 self-center grid grid-cols-2 sm:flex divide-x-2  h-fit sm:h-10 justify-between text-center">
                        <button type="button"
                            className={`text-sm grow h-full px-2 py-1 flex items-center gap-2 ${content == "Propietario" ? "bg-accent text-white cursor-auto" : "bg-white text-accent cursor-pointer "} transition-all`}
                            onClick={() => setContent("Propietario")}> <FaHouseUser className="text-lg" />Quiero arrendar</button>
                        <button type="button"
                            className={` text-sm grow h-full px-2 py-1 flex items-center gap-2  ${content == "Arrendatario" ? "bg-accent text-white cursor-auto" : "bg-white text-accent cursor-pointer "} transition-all`}
                            onClick={() => setContent("Arrendatario")}> <FaKey className="text-lg" /> Busco un arriendo</button>
                        <button type="button"
                            className={`text-sm grow h-full px-2 py-1 flex items-center gap-2 ${content == "Vendedor" ? "bg-accent text-white cursor-auto" : "bg-white text-accent cursor-pointer "} transition-all`}
                            onClick={() => setContent("Vendedor")}> <FaBriefcase className="text-lg" /> Quiero vender</button>
                        <button type="button"
                            className={`text-sm grow h-full px-2 py-1 flex items-center gap-2 ${content == "Comprador" ? "bg-accent text-white cursor-auto" : "bg-white text-accent cursor-pointer "} transition-all`}
